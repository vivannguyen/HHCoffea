...
# BDT score
        ...
        selection = {
                "signal" : [
                    ...
                    "event.leading_lep_pt{sys}  > 25",
                    "event.trailing_lep_pt{sys} > 15",
    ...
    def process(self, df, *args):
        features = ['met_pt','Higgsbb_cand_pt','Higgsbb_cand_mass','HiggsZZ_cand_mass','Zlep_cand_mass', 'HH_cand_mass',
        ...
        model.load_model(f'models/{year_str}-ee-2btag-met75')
